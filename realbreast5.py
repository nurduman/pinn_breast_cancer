...
net = dde.nn.FNN([3] + [128] * 3 + [1], "tanh", "Glorot uniform")
...
optimizer = torch.optim.Adam([
    ...
    {"params": [radius, depth], "lr": 0.01}  # Higher LR for trainable parameters
])
...
print(f"Final optimized radius: {radius.item() * L}")
print(f"Final optimized depth: {depth.item() * L}")
